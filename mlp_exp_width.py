...
width_layer = int(os.getenv('WIDTH_LAYER'))
print(width_layer)
MODEL_FNAME = f'/home/group04/M3/w3/models/mlp_width{width_layer}.h5'
...
model.add(Dense(units=width_layer, activation='relu',name='second'))
