...
MODEL_FNAME = f'/home/group04/M3/w3/models/mlp_imagesize_{IMG_SIZE}.h5'
...
print(model.summary())
plot_model(model, to_file=f'./plots/modelMLP_imagesize{IMG_SIZE}.png', show_shapes=True, show_layer_names=True)
...
plt.savefig(f'./plots/accuracy_imagesize{IMG_SIZE}.jpg')
plt.close()
...
plt.xlabel('epoch')
plt.legend(['train', 'validation'], loc='upper left')
plt.savefig(f'./plots/loss_imagesize{IMG_SIZE}.jpg')
